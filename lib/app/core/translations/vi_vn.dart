abstract class ViVn {
  static const Map<String, String> translations = {
    ...
    'guardian_subscription_expired': 'Can dang ky',
    'guardian_subscription_expired_message':
        'Tin binh an moi ngay nay da dung lai.\nChi voi gia mot bua trua, hay o ben nguoi than suot ca nam.',
    ...
    'phone_call_failed': 'Khong the thuc hien cuoc goi.',
    ...
    'add_subject_phone_label': 'So dien thoai (tuy chon)',
    'add_subject_phone_info': 'Neu nhap, nut goi se goi truc tiep den so nay. Neu de trong, ban phai tu chon so trong danh ba de goi.',
