abstract class EnUs {
  static const Map<String, String> translations = {
    ...
    'emergency_sent_with_location': 'Emergency alert sent (with location)',
    'emergency_sent_without_location': 'Emergency alert sent',
    'notifications_view_location': '🗺️ View location',
    'emergency_map_title': 'Emergency location',
    'emergency_map_subject_label': 'Subject',
    'emergency_map_captured_at_label': 'Captured at',
    ...
    'phone_call_failed': 'Unable to place the call.',
    ...
    'add_subject_phone_label': 'Phone Number (Optional)',
    'add_subject_phone_info': 'If entered, the call button dials this number directly. If left empty, you have to pick the contact from your contact list.',
    'add_subject_phone_hint': '2015550123',
    ...
    'settings_expired': 'Subscription needed',
    ...
    'offline_alarm_title': '📶 Check your internet connection',
    'offline_alarm_body': "Tap this notification once you're back online.\nOtherwise today's wellness check won't be sent.",
    ...
    'notification_send_failed_body': 'Tap this message to resend automatically.',
  };
}
