abstract class ZhTw {
  static const Map<String, String> translations = {
    ...
    'onboarding_gs_switch_title': '也一起守護家人的安康吧',
    'onboarding_gs_switch_desc': '點選選單中的[同時管理家人的安康]\n即可同時使用守護者角色',
    'onboarding_add_subject_title': '與重要的人連結',
    'onboarding_add_subject_desc': '輸入收到的專屬碼與別名\n即可立即完成連結',
    'onboarding_notifications_title': '安否通知會這樣顯示',
    'onboarding_notifications_desc': '平時會顯示步數等活動資訊，若未收到安否或沒有偵測到活動記錄，就會像上面這樣收到通知',
