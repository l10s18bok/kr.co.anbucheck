abstract class ZhTw {
  static const Map<String, String> translations = {
    ...
    'notifications_level_caution_desc': '尚無平安訊號或未偵測到手機使用痕跡',
    'notifications_level_warning': '警告',
    'notifications_level_warning_desc': '連續多日無平安訊號或未偵測到手機使用痕跡',
    ...
    'noti_warning_suspicious_body': '連續未偵測到手機使用痕跡。請親自核實。',
    'noti_urgent_body': '已@days天未收到問安。需要立即確認。',
    'noti_urgent_suspicious_body': '已連續@days天未偵測到手機使用痕跡。需要立即核實。',
