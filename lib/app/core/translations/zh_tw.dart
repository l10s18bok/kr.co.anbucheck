abstract class ZhTw {
  static const Map<String, String> translations = {
    ...
    'permission_location_desc': '僅在發送緊急求助時將目前位置傳送給守護者',
    ...
    'permission_hibernation_message':
        'Android會自動撤銷長時間未使用應用程式的權限。Anbu平時幾乎不會被開啟，如果此功能開啟，一段時間後權限會消失，導致平安訊號傳輸中斷。\n\n點選下方[開啟設定]後，會直接顯示對應的開關畫面。請關閉該開關。\n\n※ 顯示文字可能因裝置製造商而略有不同。',
    ...
    'stability_battery_dialog_message':
        '當手機進入省電模式時，傳送給守護者的平安訊號可能延遲或遺失。\n\n點選下方[開啟設定]後，請將「電池」設定為「無限制」。如此可以確保每天準時穩定地傳輸平安訊號。\n\n※ 顯示文字可能因裝置製造商而略有不同。',

    // ── 引導頁 ──
    'onboarding_safety_code_title': '安全碼會自動產生',
    'onboarding_safety_code_desc': '把這組碼告訴守護者即可連結，\n你的平安訊息會自動送出。',
    'onboarding_emergency_title': '想告知目前狀態（緊急）和位置時',
    'onboarding_emergency_desc': '點下這個按鈕會立即\n傳達給所有守護者',
    'onboarding_gs_switch_title': '也一起守護家人的平安',
    'onboarding_gs_switch_desc': '點選選單中的[同時管理家人的平安]\n即可同時使用守護者角色',
    'onboarding_add_subject_title': '與重要的人連結',
    'onboarding_add_subject_desc': '輸入收到的專屬碼與別名\n即可立即完成連結',
    'onboarding_notifications_title': '平安通知會這樣顯示',
    'onboarding_notifications_desc': '平時會顯示步數等活動資訊，若未收到平安信號或沒有偵測到活動記錄，就會像上面這樣收到通知',
    'onboarding_push_now': '現在',
    'onboarding_gs_enable_title': '啟用我的安全碼',
    'onboarding_gs_enable_desc': '在設定中點選[產生我的安全碼]\n我的平安也會傳達給守護者',
    ...
    'safety_net_dialog_already_body': '今天的安全回報已於 @time 傳送給守護者。',
    'subject_home_emergency_confirm_title': '緊急求助',
    'subject_home_emergency_confirm_body': '將向所有守護者發送緊急警報。\n目前位置也會一同分享。\n確定要請求幫助嗎？',
    ...
    'emergency_map_subject_label': '被守護者',
    ...
    'subject_home_share_subject': 'Anbu 安全碼',
    'subject_home_code_copied': '安全碼已複製',
    ...
    'add_subject_phone_label': '聯絡方式（選填）',
    'add_subject_phone_info': '填寫後點擊撥打按鈕可直接撥號；留空則需從通訊錄中自行選擇號碼。',
    'add_subject_phone_hint': '0912345678',
    'add_subject_connect': '連結',
    'add_subject_error_login': '請先登入。',
    'add_subject_success': '被守護者已成功連結。',
    'add_subject_error_invalid_code': '無效的安全碼。',
    ...
    'gs_enable_dialog_ios_warning_title': '⚠ 平安確認發送方式說明',
    'gs_enable_dialog_ios_warning_body':
        '每天會在固定時間顯示「平安推播通知」。您必須點按通知或在該時間前後親自開啟應用程式，平安信號才會傳送。若不開啟應用程式，守護者可能會收到未接收警告。',
    ...
    'drawer_enable_guardian': '同時管理家人的平安',
    's_to_gs_dialog_title': '新增守護者功能',
    's_to_gs_dialog_body':
        '新增守護者功能，即可同時關注家人或所愛之人的平安。\n（注意：守護者功能免費試用3個月，到期後將轉為付費訂閱。）\n\n您自己的安全碼和目前使用的平安信號傳送功能將維持不變，並繼續免費使用。',
    ...
    'notifications_activity_note': '※ 步數為當日零時至平安信號傳送時刻的累計步數。',
    ...
    'offline_alarm_title': '💗 今天的平安訊息尚未傳送',
    'offline_alarm_body': '請點擊此通知一次。\n點擊後會向您的守護者傳送平安訊息。',
