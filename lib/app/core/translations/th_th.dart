abstract class ThTh {
  static const Map<String, String> translations = {
    ...
    'permission_hibernation_message':
        'Android จะลบสิทธิ์ของแอปที่คุณไม่ได้ใช้งานเป็นเวลานานโดยอัตโนมัติ Anbu มักทำงานโดยไม่ได้เปิดขึ้นมา ดังนั้นฟีเจอร์นี้อาจทำให้สิทธิ์หายไปหลังจากผ่านไประยะหนึ่งและการส่งสัญญาณดูแลสุขภาพหยุดทำงาน\n\nแตะ [เปิดการตั้งค่า] ด้านล่าง — หน้าจอสวิตช์ที่เกี่ยวข้องจะปรากฏขึ้นทันที โปรดปิดสวิตช์\n\n※ ข้อความที่แสดงอาจแตกต่างกันไปตามผู้ผลิตอุปกรณ์',
    ...
    'stability_battery_dialog_message':
        'เมื่อโทรศัพท์ของคุณเข้าสู่โหมดประหยัดพลังงาน สัญญาณดูแลสุขภาพที่ส่งไปยังผู้ดูแลของคุณอาจมาช้าหรือสูญหาย\n\nหลังจากแตะ [เปิดการตั้งค่า] ด้านล่าง ให้ตั้งค่า "แบตเตอรี่" → "ไม่จำกัด" จากนั้นสัญญาณดูแลสุขภาพจะถูกส่งอย่างน่าเชื่อถือในเวลาที่กำหนดทุกวัน\n\n※ ข้อความที่แสดงอาจแตกต่างกันไปตามผู้ผลิตอุปกรณ์',
    ...
    'onboarding_gs_switch_title': 'ดูแลความสุขสบายของครอบครัวไปด้วยกัน',
    'onboarding_gs_switch_desc':
        'แตะ [ดูแลสุขภาวะของครอบครัวด้วย] ในเมนู\nเพื่อใช้บทบาทผู้ดูแลไปด้วย',
    ...
    'gs_enable_dialog_ios_warning_title': '⚠ วิธีการส่งสัญญาณสุขภาพของคุณ',
    'gs_enable_dialog_ios_warning_body':
        'จะมี "การแจ้งเตือนพุชสุขภาพ" ปรากฏทุกวันตามเวลาที่กำหนด คุณต้องแตะที่การแจ้งเตือนหรือเปิดแอปด้วยตัวเองในช่วงเวลานั้น สัญญาณสุขภาพของคุณจึงจะถูกส่ง หากคุณไม่เปิดแอป ผู้ดูแลของคุณอาจได้รับการแจ้งเตือนการตรวจสอบที่พลาดไป',
    ...
    'drawer_enable_guardian': 'ดูแลสุขภาวะของครอบครัวด้วย',
    's_to_gs_dialog_title': 'เพิ่มฟีเจอร์ผู้ดูแล',
    's_to_gs_dialog_body':
        'เพิ่มฟีเจอร์ผู้ดูแลเพื่อดูแลสุขภาวะของครอบครัวหรือคนที่คุณรักได้ด้วย\n(หมายเหตุ: ฟีเจอร์ผู้ดูแลใช้งานฟรี 3 เดือน จากนั้นจะเปลี่ยนเป็นการสมัครสมาชิกแบบชำระเงิน)\n\nรหัสความปลอดภัยของคุณและการส่งสัญญาณสุขภาวะที่ใช้อยู่ในปัจจุบันจะยังคงเดิมและใช้งานฟรีต่อไป',
