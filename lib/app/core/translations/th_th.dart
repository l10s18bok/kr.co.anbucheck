abstract class ThTh {
  static const Map<String, String> translations = {
    ...
    'add_subject_guide_title':
        'กรอกรหัสเฉพาะของผู้อยู่ในการดูแล\nและชื่อเล่น',
    'add_subject_guide_subtitle':
        'เชื่อมต่อแอปของผู้อยู่ในการดูแลเพื่อติดตาม\nสุขภาพและกิจกรรมแบบเรียลไทม์',
    ...
    'local_alarm_title': '📱 จำเป็นต้องตรวจสอบความเป็นอยู่',
    'local_alarm_body': 'กรุณาแตะการแจ้งเตือนนี้',
