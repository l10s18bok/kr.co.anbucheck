abstract class ThTh {
  static const Map<String, String> translations = {
    ...
    // ── การแนะนำ ──
    'onboarding_title_1': 'คนที่คุณรักอยู่คนเดียว\nถามไถ่ทุกวันไม่ใช่เรื่องง่าย',
    'onboarding_desc_1': 'อยู่ไกล และคุณก็เป็นห่วง\nว่าวันนี้เขาเป็นยังไง\nAnbu ส่งข่าวแทนคุณ',
    'onboarding_title_2': 'คำที่ไม่ต้องพูด\nก็ส่งถึงกันได้',
    'onboarding_desc_2': 'ชีวิตประจำวันของคุณ\nคือข้อมูลสำคัญ\nสำหรับคนที่เป็นห่วงคุณ',
    'onboarding_title_3': 'แบ่งปันความห่วงใย\nกับคนที่คุณรัก',
    'onboarding_desc_3': 'ความห่วงใยในแต่ละวัน\nกลายเป็นความอุ่นใจของทั้งสอง\nติดต่อเองเมื่อจำเป็นจริงๆ เท่านั้น',
    'onboarding_title_4': 'ใกล้กันในใจ แต่\nไม่ต้องรู้ทุกรายละเอียด',
