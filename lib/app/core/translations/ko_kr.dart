abstract class KoKr {
  static const Map<String, String> translations = {
    ...
    'onboarding_gs_enable_title': '내 안전 코드 활성화',
    'onboarding_gs_enable_desc':
        '설정에서 [내 안전 코드 생성]을 누르면\n내 안부도 보호자에게 전해져요',
    ...
    'safety_net_dialog_body': '오늘의 안부가 보호자에게 전달되었습니다.',
    'safety_net_dialog_already_body':
        '오늘의 안부는 이미 @time에 보호자에게 전달되었습니다.',
    'subject_home_emergency_confirm_title': '긴급 도움 요청',
    'subject_home_emergency_confirm_body':
        '보호자 전원에게 긴급 알림이 발송됩니다.\n현재 위치도 함께 전달됩니다.\n정말 도움을 요청하시겠습니까?',
    'emergency_sent_with_location': '긴급 알림이 전송되었습니다 (위치 포함)',
    'emergency_sent_without_location': '긴급 알림이 전송되었습니다',
    'notifications_view_location': '🗺️ 위치 보기',
    'emergency_map_title': '긴급 위치',
    'emergency_map_subject_label': '대상자',
    'emergency_map_captured_at_label': '수집 시각',
    ...
    'phone_call_failed': '전화를 걸 수 없습니다.',
    ...
    'add_subject_phone_label': '연락처 (선택)',
    'add_subject_phone_info': '입력하면 전화 버튼으로 바로 걸 수 있고, 비워 두면 연락처 목록에서 직접 골라야 합니다.',
    'add_subject_phone_hint': '01012345678',
    ...
    'gs_enable_dialog_body':
        '활성화하면 안전 코드가 발급됩니다. 다른 보호자에게 내 "안전 코드"를 알려주세요.',
    ...
    'notifications_level_caution_desc': '아직 안부 신호가 없거나 활동 기록이 감지되지 않아요',
    'notifications_level_warning': '경고',
    'notifications_level_warning_desc': '연속으로 안부 신호가 없거나 활동 기록이 감지되지 않아요',
    ...
    'noti_caution_suspicious_body': '안부는 수신되었으나 오늘 활동 기록이 감지되지 않습니다. 직접 확인해 주세요.',
    'noti_caution_missing_body': '오늘 예정된 안부 확인이 아직 없습니다. 직접 확인해 주세요.',
    'noti_warning_body': '연속으로 안부 확인이 되지 않고 있습니다. 직접 확인이 필요합니다.',
    'noti_warning_suspicious_body': '연속으로 활동 기록이 감지되지 않습니다. 직접 확인이 필요합니다.',
    'noti_urgent_body': '@days일간 안부 확인이 없습니다. 즉시 확인이 필요합니다.',
    'noti_urgent_suspicious_body': '@days일 연속 활동 기록이 감지되지 않습니다. 즉시 확인이 필요합니다.',
    ...
    'notification_send_failed_body': '이 메시지를 터치하면 자동으로 재전송합니다.',
  };
}
