abstract class ZhCn {
  static const Map<String, String> translations = {
    ...
    'onboarding_gs_switch_title': '也一起守护家人的安康吧',
    'onboarding_gs_switch_desc': '点击菜单中的[同时管理家人的安康]\n即可同时使用守护者角色',
    'onboarding_add_subject_title': '与重要的人连接',
    'onboarding_add_subject_desc': '输入收到的专属码和别名\n即可立即完成连接',
    'onboarding_notifications_title': '安否通知会这样显示',
    'onboarding_notifications_desc': '平时会显示步数等活动信息，若未收到安否或没有检测到活动记录，就会像上面这样收到通知',
    ...
    'safety_net_dialog_already_body': '今天的安全报告已于 @time 发送给监护人。',
    ...
    'emergency_map_subject_label': '对象',
