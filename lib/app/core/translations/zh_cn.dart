abstract class ZhCn {
  static const Map<String, String> translations = {
    ...
    'notifications_level_caution_desc': '尚无平安信号或未检测到手机使用痕迹',
    'notifications_level_warning': '警告',
    'notifications_level_warning_desc': '连续多日无平安信号或未检测到手机使用痕迹',
    ...
    'noti_warning_suspicious_body': '连续未检测到手机使用痕迹。请亲自核实。',
    'noti_urgent_body': '已@days天未收到问安。需要立即确认。',
    'noti_urgent_suspicious_body': '已连续@days天未检测到手机使用痕迹。需要立即核实。',
