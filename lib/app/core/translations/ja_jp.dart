abstract class JaJp {
  static const Map<String, String> translations = {
    ...
    'notifications_level_caution_desc': 'まだ安否信号がないか、スマホの使用跡が検出されていません',
    'notifications_level_warning': '警告',
    'notifications_level_warning_desc': '連続して安否信号がないか、スマホの使用跡が検出されていません',
    ...
    'noti_warning_suspicious_body': 'スマートフォンの使用形跡が連続して検出されていません。直接のご確認が必要です。',
    'noti_urgent_body': '@days日間安否確認がありません。直ちに確認が必要です。',
    'noti_urgent_suspicious_body': '@days日連続でスマートフォンの使用形跡が検出されていません。直ちにご確認が必要です。',
