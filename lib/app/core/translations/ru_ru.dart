abstract class RuRu {
  static const Map<String, String> translations = {
    ...
    'offline_alarm_title': '📶 Проверьте подключение к интернету',
    'offline_alarm_body': 'Нажмите на это уведомление, когда снова появится интернет.\nИначе сегодняшний сигнал не будет отправлен.',
