abstract class RuRu {
  static const Map<String, String> translations = {
    ...
    // ── Онбординг ──
    'onboarding_title_1': 'Кто-то из близких живёт один\nпроверять каждый день непросто',
    'onboarding_desc_1':
        'Далеко, и ты думаешь,\nвсё ли сегодня хорошо.\nAnbu передаст весточку за тебя.',
    'onboarding_title_2': 'Слово, которое приходит\nбез слов',
    'onboarding_desc_2':
        'Твоя повседневная жизнь —\nважная весточка для тех,\nкто думает о тебе.',
    'onboarding_title_3': 'Делитесь новостями\nс близкими людьми',
    'onboarding_desc_3':
        'Ежедневные сигналы\nстановятся спокойствием для обоих.\nЗвони, только когда это важно.',
    'onboarding_title_4': 'Близко к сердцу, но\nне в каждую минуту',
    'onboarding_desc_4':
