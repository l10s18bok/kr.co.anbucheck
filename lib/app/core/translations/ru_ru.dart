abstract class RuRu {
  static const Map<String, String> translations = {
    ...
    'permission_hibernation_message':
        'Android автоматически удаляет разрешения у приложений, которые долго не использовались. Anbu обычно работает без открытия, поэтому через некоторое время разрешения могут исчезнуть, и отправка сигнала благополучия прекратится.\n\nНажмите [Открыть настройки] ниже — соответствующий экран с переключателем появится сразу. Отключите переключатель.\n\n※ Точные формулировки могут отличаться в зависимости от производителя устройства.',
    ...
    'stability_battery_dialog_message':
        'Когда ваш телефон переходит в режим энергосбережения, сигналы благополучия могут поступать опекуну с задержкой или вовсе теряться.\n\nПосле нажатия [Открыть настройки] ниже установите "Батарея" → "Без ограничений". Тогда сигналы благополучия будут надёжно отправляться в назначенное время каждый день.\n\n※ Точные формулировки могут отличаться в зависимости от производителя устройства.',

    // ── Онбординг ──
    'onboarding_safety_code_title': 'Ваш код безопасности создаётся автоматически',
    'onboarding_safety_code_desc':
        'Поделитесь этим кодом с опекуном, чтобы связаться —\nваш сигнал благополучия будет отправляться автоматически.',
    ...
    'onboarding_gs_switch_title': 'Заботьтесь и о благополучии своей семьи',
    ...
    'onboarding_notifications_title': 'Вот как выглядят уведомления о благополучии',
    ...
    'onboarding_gs_enable_title': 'Активируйте свой код благополучия',
    'onboarding_gs_enable_desc':
        'В Настройках нажмите [Получать защиту тоже],\nчтобы ваше благополучие тоже передавалось опекунам',
    ...
    'safety_net_dialog_title': 'Проверка благополучия отправлена',
    'safety_net_dialog_body':
        'Сегодняшняя проверка благополучия отправлена вашему опекуну.',
    'safety_net_dialog_already_body':
        'Сегодняшняя проверка благополучия уже была отправлена вашему опекуну в @time.',
    ...
    'add_subject_phone_label': 'Номер телефона',
    'add_subject_phone_info': 'Необязательно. Если указан, кнопка звонка наберёт этот номер напрямую.',
    ...
    'gs_enable_dialog_ios_warning_title': '⚠ Как отправляется ваш сигнал благополучия',
    'gs_enable_dialog_ios_warning_body':
        'Каждый день в установленное время появляется «push-уведомление о благополучии». Вы должны нажать на уведомление или сами открыть приложение в это время, чтобы ваш сигнал благополучия был отправлен. Если вы не откроете приложение, опекуны могут получить предупреждение о пропущенной проверке.',
    ...
    'notifications_activity_note':
        '※ Количество шагов — это накопленные шаги с полуночи до момента отправки сигнала безопасности.',
