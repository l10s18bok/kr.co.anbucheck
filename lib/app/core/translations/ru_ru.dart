abstract class RuRu {
  static const Map<String, String> translations = {
    ...
    'permission_battery_required_title': 'Установите батарею в режим "Без ограничений"',
    'permission_battery_required_message':
        'Если установлен режим "Оптимизация батареи" или "Энергосбережение", ежедневные проверки самочувствия могут задерживаться или пропускаться.\n\nПосле нажатия [Перейти в настройки]:\n1. Выберите "Батарея"\n2. Измените на "Без ограничений"',
    'permission_battery_go_to_settings': 'Перейти в настройки',
