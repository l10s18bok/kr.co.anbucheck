abstract class HiIn {
  static const Map<String, String> translations = {
    ...
    'permission_hibernation_message':
        'Android लंबे समय तक उपयोग न किए गए ऐप्स की अनुमतियाँ स्वचालित रूप से हटा देता है। Anbu आमतौर पर बिना खोले चलता है, इसलिए यह सुविधा कुछ समय बाद अनुमतियों को गायब कर सकती है और सलामती संकेत भेजना बंद कर सकती है।\n\nनीचे [सेटिंग्स खोलें] पर टैप करें — संबंधित स्विच स्क्रीन सीधे दिखाई देगी। स्विच बंद कर दें।\n\n※ सटीक शब्द डिवाइस निर्माता के अनुसार भिन्न हो सकते हैं।',
    'permission_hibernation_go_to_settings': 'सेटिंग्स खोलें',
    ...
    // ── ऑनबोर्डिंग ──
    'onboarding_title_1': 'आपका कोई अपना अकेला रहता है\nहर रोज़ हालचाल लेना आसान नहीं',
    'onboarding_desc_1': 'दूर हैं, और मन में सवाल\nकि आज वो ठीक तो हैं।\nAnbu आपकी तरफ़ से ख़बर पहुँचाता है।',
    'onboarding_title_2': 'एक शब्द जो\nबिना कहे पहुँच जाता है',
    'onboarding_desc_2':
        'आपकी रोज़ की ज़िंदगी\nआपकी ख़बर चाहने वालों के लिए\nज़रूरी जानकारी है।',
    'onboarding_title_3': 'अपने प्रियजनों के साथ\nकुशलता साझा करें',
    'onboarding_desc_3': 'हर दिन की ख़बर जुड़कर\nदोनों का सुकून बनती है।\nख़ुद तभी पहुँचें जब सच में ज़रूरत हो।',
    'onboarding_title_4': 'दिल से करीब, पर\nहर पल की ख़बर ज़रूरी नहीं',
    ...
    'settings_expired': 'सदस्यता आवश्यक',
