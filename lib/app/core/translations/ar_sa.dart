abstract class ArSa {
  static const Map<String, String> translations = {
    ...
    'permission_hibernation_message':
        'يقوم Android تلقائيًا بإزالة أذونات التطبيقات التي لم تستخدمها لفترة طويلة. عادةً ما يعمل Anbu دون فتحه، لذا قد تؤدي هذه الميزة إلى اختفاء الأذونات بعد فترة وتوقف إرسال إشارة الاطمئنان.\n\nاضغط على [فتح الإعدادات] أدناه — ستظهر شاشة المفتاح المعني مباشرةً. أوقف تشغيل المفتاح.\n\n※ قد تختلف الصياغة الدقيقة حسب الشركة المصنّعة للجهاز.',
    'permission_hibernation_go_to_settings': 'فتح الإعدادات',
    'stability_battery_warning_short': 'يلزم إلغاء قيود استخدام البطارية',
    'stability_battery_dialog_title': 'إلغاء قيود استخدام البطارية',
    'stability_battery_dialog_message':
        'عندما يدخل هاتفك في وضع توفير الطاقة، قد تصل إشارات الاطمئنان إلى وليّ أمرك متأخرةً أو يتم تفويتها.\n\nبعد الضغط على [فتح الإعدادات] أدناه، اضبط "البطارية" → "بدون قيود". بهذا تُرسَل إشارات الاطمئنان بشكل موثوق في الوقت المحدد كل يوم.\n\n※ قد تختلف الصياغة الدقيقة حسب الشركة المصنّعة للجهاز.',

    // ── التهيئة الأولية ──
    'onboarding_title_1': 'من تحبّه يعيش وحده\nالتفقُّد عليه كل يوم ليس سهلاً',
    'onboarding_desc_1': 'بعيد، وقلبك يتساءل\nهل هو بخير اليوم.\nAnbu يوصل الاطمئنان عنك.',
    'onboarding_title_2': 'كلمة تصل\nدون أن تُنطق',
    'onboarding_desc_2': 'حياتك اليومية\nمعلومة مهمة\nلمن يهتمّ لأمرك.',
    'onboarding_title_3': 'شارك الاطمئنان\nمع أحبائك',
    'onboarding_desc_3': 'كل اطمئنان يومي يتراكم\nليصبح طمأنينة للطرفين.\nتواصل فقط حين يهمّ الأمر.',
    'onboarding_title_4': 'قريب من القلب، لكن\nليس في كل تفاصيل يومك',
    ...
    'settings_expired': 'الاشتراك مطلوب',
